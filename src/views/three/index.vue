...
export default defineComponent({
  setup() {
    ...
    onMounted(() => {
       ...
       * boxGeometry 中有一个 attribute 属性，该属性的基类是 BufferGeometry，基类中包含了顶点位置(position)、法线量(normal)和 UV 坐标(uv)
       ...
       * 法线: 举例: 一束光照到几何体上，会有一个反射同时会有一定的角度，反射的角度是根据被照射面的朝向来决定的，法线就描述了被照射面的朝向
       *
